defmodule FusionAuth.JWT do
  ...
  """
  @spec get_jwt_by_application_id(FusionAuth.client(), String.t(), String.t() | nil) :: FusionAuth.response()
  ...
  """
  @spec reconcile_jwt(FusionAuth.client(), String.t(), map(), String.t()) :: FusionAuth.response()
  ...
  """
  @spec get_public_keys(FusionAuth.client()) :: FusionAuth.response()
  ...
  For more information, visit the FusionAuth API Documentation for [Retrieve Public Keys](https://fusionauth.io/docs/v1/tech/apis/jwt#retrieve-public-keys).
  """
  @spec get_public_key_by_application_id(FusionAuth.client(), String.t() | nil) :: FusionAuth.response()
  ...
  For more information, visit the FusionAuth API Documentation for [Retrieve Public Keys](https://fusionauth.io/docs/v1/tech/apis/jwt#retrieve-public-keys).
  """
  @spec get_public_key_by_key_id(FusionAuth.client(), String.t() | nil) :: FusionAuth.response()
  ...
  """
  @spec refresh_jwt(FusionAuth.client(), String.t() | nil, String.t() | nil) :: FusionAuth.response()
  ...
  """
  @spec get_user_refresh_tokens_by_user_id(FusionAuth.client(), String.t()) :: FusionAuth.response()
  ...
  For more information, visit the FusionAuth API Documentation for [Retrieve Refresh Tokens](https://fusionauth.io/docs/v1/tech/apis/jwt#retrieve-refresh-tokens).
  """
  @spec get_user_refresh_tokens(FusionAuth.client()) :: FusionAuth.response()
  ...
  """
  @spec delete_refresh_tokens_by_application_id(FusionAuth.client(), String.t()) :: FusionAuth.response()
  ...
  For more information, visit the FusionAuth API Documentation for [Revoke Refresh Tokens](https://fusionauth.io/docs/v1/tech/apis/jwt#revoke-refresh-tokens).
  """
  @spec delete_refresh_tokens_by_user_id(FusionAuth.client(), String.t()) :: FusionAuth.response()
  ...
  For more information, visit the FusionAuth API Documentation for [Revoke Refresh Tokens](https://fusionauth.io/docs/v1/tech/apis/jwt#revoke-refresh-tokens).
  """
  @spec delete_refresh_token(FusionAuth.client(), String.t()) :: FusionAuth.response()
  ...
  """
  @spec validate_jwt(FusionAuth.client()) :: FusionAuth.response()
